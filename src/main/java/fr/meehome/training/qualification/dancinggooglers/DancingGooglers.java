...
public class DancingGooglers {
    ...
    private static final String FILE_SMALL_OUTPUT_NAME = "src/main/resources/fr/corpoconcept/petiteannonce/qualification/dancinggooglers/B-small-practice.out";

    private static final String FILE_SMALL_INPUT_NAME = "src/main/resources/fr/corpoconcept/petiteannonce/qualification/dancinggooglers/B-small-practice.in";

    private static final String FILE_LARGE_OUTPUT_NAME = "src/main/resources/fr/corpoconcept/petiteannonce/qualification/dancinggooglers/B-large-practice.out";

    private static final String FILE_LARGE_INPUT_NAME = "src/main/resources/fr/corpoconcept/petiteannonce/qualification/dancinggooglers/B-large-practice.in";
